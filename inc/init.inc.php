...
define("RACINE_SITE", "/bestsellers/"); // permet d'avoir le chemin absolu afin de gérer les incohérences de l'arboréscence de notre projet
define("RACINE_SERVER", $_SERVER['DOCUMENT_ROOT']); // permet d'avoir un chemin automatisé
//define("RACINE_SERVER", $_SERVER['http://www.indiancornner.com']); // permet d'avoir un chemin automatisé
//define("RACINE_SERVER", "http://www.indiancornner.com/"]); // permet d'avoir un chemin automatisé
